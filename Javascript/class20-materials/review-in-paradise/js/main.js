...
function cubeRoot(robot){
    ...
    //math is a method that contain cbrt (cube root function) that
    //calculates the cube root. toFixed limits your number of decimal places
    //after the decimal.
}
cubeRoot(9);
// *Conditionals*
