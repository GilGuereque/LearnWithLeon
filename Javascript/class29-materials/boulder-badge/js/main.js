// Variables
//You are getting ready to face Brock for the Boulder Badge. You want three pokemon on your team that each have evolved at least once. You have bulbasaur which is at 
//level 5 and evolves at level 16, caterpie which is at level 1 and evolves at level 7, and weedle which is at level 1 and evolves at level 7. 
...
function canCharmanderBattle(currentTemp){
    ...
    if(converted > 0){
        ...
        console.log('Charmander can not battle bruh!');
    }
};
canCharmanderBattle(33);

//my function (i did not call the previous converter function so this isn't working; Leon's function does call the converter function so that it can be checked):
// function charmanderCanBattle(temp){
//     if(convertedToCel > 0){
//         console.log("Charmander can battle!");
//     } else{
//         console.log("This is ain't it for Charmanda!!");
//     }
// };
// charmanderCanBattle(31);
...
undegroundPokemonLeague(['bulbasuar','caterpie','weedle']);